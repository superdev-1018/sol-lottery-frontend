          ...
          >
            {
              ...
              >
                ...
                <ListItem sx={{ margin: 0, padding: '1px 8px' }}>
                  <ListItemText primary={`Prize pool: ${(lottery.account.realPoolAmount/LAMPORTS_PER_SOL).toFixed(3)} SOL`} />
                </ListItem>
                <ListItem sx={{ margin: 0, padding: '1px 8px' }}>
                  <ListItemText primary={`Winning tax: ${lottery.account.devFee}%`} />
                </ListItem>
                <ListItem sx={{ margin: 0, padding: '1px 8px' }}>
                  <ListItemText primary={`1: ${lottery.account.winner[0]} = ${(lottery.account.winnerPrize[0]/LAMPORTS_PER_SOL).toFixed(3)} SOL`} />
                </ListItem>
                <ListItem sx={{ margin: 0, padding: '1px 8px' }}>
                  <ListItemText primary={`2: ${lottery.account.winner[1]} = ${(lottery.account.winnerPrize[1]/LAMPORTS_PER_SOL).toFixed(3)} SOL`} />
                </ListItem>
                <ListItem sx={{ margin: 0, padding: '1px 8px' }}>
                  <ListItemText primary={`3: ${lottery.account.winner[2]} = ${(lottery.account.winnerPrize[2]/LAMPORTS_PER_SOL).toFixed(3)} SOL`} />
                </ListItem>
              </List>
              )): null
            }
